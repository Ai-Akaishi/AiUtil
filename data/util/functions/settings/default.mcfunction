...
# advanced機能実行地点
execute unless data storage util: settings.at run data modify storage util: settings.at set value {Pos:[0d,0d,0d],Rotation:[0f,0f],Dimension:"minecraft:overworld"}

...
tellraw @s {"translate":"出力%1$s: %2$s%3$s","with":[{"text":"(util: out)","color":"gray"},{"text":"日時データ","bold":true},{"text":"({year:int,month:int,day:int,hour:int,minute:int,second:int})","color":"gray"}]}
